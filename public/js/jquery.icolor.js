...
(function($) {
    ...
    p.M.prototype = {
        ...
        _initLayout: function() {
            ...
            var html = '<div class="' + this.className + '" id="icolor_' + p.getId() + '">',
                title = "";
            ...
            this.$colors.click(function(e) {
                // if (this.className == "hot") return;// bug: If I change the colour of a node to some particular colour, say FCBBA1, then go to another node and try to change the colour to the exact same colour, nothing happens. I have to choose a different colour.
    ...
    $.fn.icolor.defaults = {
        trigger: 'click',
        /* event name for triggering to show icolor */
        flat: false,
        /* inline mode */
        col: 8,
        /* column number of icolor */
        colors: [],
        /* user predefined colors */
        showInput: false,
        /* show a input box after the color elements */
        cl: "icolor",
        /* css class for icolor */
        title: true,
        /* whether include title attribute for the color element */
        autoClose: true,
        /* auto-close after selecting a color  */
        slide: true,
        /* use the 'slideDown' effect when showing icolor */
        okTpl: '',
        /* ok button template such as <button class="icolor_ok">ȷ��<button> */
        onShow: null,
        /* onShow callback */
        onSelect: null,
        /* onSelect callback */
        ...
        /* afterInit callback */
        onOver: null,
        /* callback for mouseover a color element */
        onOut: null,
        /* callback for mouseout the whole icolor */
